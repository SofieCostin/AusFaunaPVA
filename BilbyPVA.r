...
# fertility errors
#### SD will need changing once other SDs are found, no data available ####
pr.breed.sd <- 0.2
...
s.vec <- c(((juv.surv*0.25) + (imm.surv*0.25) + (sAd.surv*0.25) + (ad.surv*0.25)), rep(ad.surv, age.max))
...
red.vec <- c(1,0.98,0.88,0.78,0.82)
